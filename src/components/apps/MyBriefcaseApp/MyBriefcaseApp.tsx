...
import { myBriefcaseFs } from '../../../data/fileSystem';
...
const MyBriefcaseApp: FunctionComponent<AppProps> = () => {
  const { files, focusOnFile, removeFocus } = useShellFilesState(myBriefcaseFs);
  ...
  return (
    <WindowContent
      menu={<MenuBar options={['File', 'Edit', 'View', 'Briefcase', 'Help']} />}
      body={
        <Countour>
          <Scrollable>
            <FileGrid
