...
import { networkNeighborhoodFs } from '../../../data/fileSystem';
...
const NetworkNeighborhoodApp: FunctionComponent<AppProps> = () => {
  const { files, focusOnFile, removeFocus } = useShellFilesState(
    networkNeighborhoodFs
  );
...
export default NetworkNeighborhoodApp;
